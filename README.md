...
> `rails generate live_record:install --live_dom=false` if you do not need the `LiveDom` plugin
...
> Your controller must also support responding with JSON in addition to HTML. If you used scaffold generator, this is automatically supported.
